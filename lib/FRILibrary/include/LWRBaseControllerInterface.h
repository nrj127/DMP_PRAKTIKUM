...
//  ----------------------------------------------------------
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline int GetCurrentGravityVector(float *CurrentGravityVector)
    //!
    //! \brief
    ...
    //! </ul>
    //  ----------------------------------------------------------
        inline int GetCurrentGravityVector(float *CurrentGravityVector)
        {
            this->FRI->GetCurrentGravityVector(CurrentGravityVector);
